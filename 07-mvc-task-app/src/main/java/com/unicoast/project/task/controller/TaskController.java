...
public class TaskController {
    // final para asegurar inmutabilidad
    // Garantiza que la referencia al repositorio no cambie durante la vida útil del controlador
    ...
    public void addTask(String id, String title, String description, Boolean completed) throws TaskValidationException, TaskException {
        ...
        System.out.println("La tarea se agregó exitosamente");
    }
    ...
    public void showAllTasks() throws TaskValidationException, TaskException {
        List<Task> tasks = this.taskRepository.findAll();

        if (tasks.isEmpty()){
            throw new TaskValidationException("La lista está vacía");
        }
        for (Task task : tasks){
